...
def lambda_handler(event, context):
    ...
    try:
        ...
        ## Get top speeds that exceed the limit 
        ...
        obj_key = f"bucket-speeders1/four-wheeler-filtered/{fdate}.csv" # filename in speeders folder
        ...
        print("Error in recordreader for four wheeler...")
        pass
